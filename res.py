...
biz_rating_text = [
    ...
    f"Отець Михайло побачив як ви відбудовуєте кіоск, тим самим створюючи конкуренцію кіоску його брата! На ранковій молитві він вирішив розказати всім, що ви трахали козу! Рейтинг серед громади впав на {biz_rating_drop[2]} пунктів"
]
