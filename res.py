...
level_captions = [
    ...
    "Депутат міської ради. Я раніше жив бідно, пас корови, продавав гриби. Одягався бідно. Мене ображали. Не вірили в мої таланти вчителі. Я не здався і доказав всім!"
]
