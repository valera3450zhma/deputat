...
help_text = "Команди бота для використання в усіх чатах:\n/get - отримати свого депутата\n/show - оглянути основні " \
            ...
            "депутату\n\nФ-ції для адміністраторів:\n/nwork - скидує дату останньої роботи депутата\n/nprovide - " \
            "скидує дату останнього забезпечення бізнесів\n/nbusiness - скидує дату останнього дня збирання коштів з " \
            "бізнесу\nЧисло (в пп боту) - встановлює значення грошей"
